...
function VideoCard(props){
  ...
  return (
    <div className='card d-flex flex-row p-0 my-1 hoverbackgroundcustom' style={{color : "white" , backgroundColor : "rgb(0,0,0)"}}>
        <img className='' src={videodetails.thumbnail} onClick={()=>{navigate("/playvideo" , {state : {obj : videodetails}})}} style={{height : "20vh" , width: "15vw" , borderRadius : "10px"}}/>
        <div className='' style={{width:"35vw" , height : "20vh"}} onClick={()=>{navigate("/playvideo" , {state : {obj : videodetails}})}}>
        ...
        <div className='py-1' style={{height : "5vh"}}>
            <button className='p-0 m-0' id="dropdownMenuButton" type='button' data-bs-toggle="dropdown"  aria-expanded="false" style={{background:"rgb(0,0,0)" , color:"white" , border : "none" , height:"4vh"}}>
                <BsThreeDotsVertical />
            </button>
